...
//       when(() => kanaTypeRepository.getKanaType2()).thenAnswer((_) => KanaType.hiragana);
...
//       when(() => kanaTypeRepository.getKanaType2()).thenAnswer((_) => KanaType.katakana);
...
//       when(() => kanaTypeRepository.getKanaType2()).thenAnswer((_) => KanaType.both);
